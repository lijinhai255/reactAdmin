...
import { Form, Select, DatePicker, TimePicker, Cascader, Input, InputNumber, 
    Switch, Radio, Slider, Button, Upload, Icon, Rate, Checkbox, Row, Col, message
} from 'antd';
...
class BlockForm extends Component {
    ...
    componentWillReceiveProps(props){
        // console.log('当数据变化，我就会被打印.第一次udidMount不会触发这个', props)
    }
    handleSubmit = e => {
        e.preventDefault();
    ...
    render() {
        ...
        return (
            <Form {...formItemLayout} onSubmit={ev => this.handleSubmit(ev)} >
                <h1 className='center'>这里是title， 如果不想要可以注释掉</h1>
                {/* 时间选择，datepicker */}
